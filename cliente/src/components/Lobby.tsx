  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl">
        ...
        {currentRoom && (
          <div className="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-xl animate-fade-in">
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-800">
                    Estás conectado a: <strong className="text-blue-900">{currentRoom.name}</strong>
                  </p>
                  <p className="text-xs text-blue-600 mt-1">
                    Puedes abrir otra pestaña para unirte a diferentes salas
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    // Volver al ChatRoom sin salir
                    window.location.reload();
                  }}
                  className="px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium transition-colors text-sm"
                >
                  Volver al Chat
                </button>
                <button
                  onClick={() => {
                    if (window.confirm(`¿Salir de "${currentRoom.name}"?`)) {
                      leaveRoom();
                    }
                  }}
                  className="px-3 py-1.5 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-medium transition-colors text-sm"
                >
                  Salir
                </button>
              </div>
